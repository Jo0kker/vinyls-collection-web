...
import { faCompactDisc, faUserMusic, faAlbumCollection, faComment, faUser, faCog } from '@fortawesome/pro-light-svg-icons';
...
const NavBar: FunctionComponent = () => {
  ...
  // const user = useQueryClient().getQueryData<User>(["me"]);
    ...
    return (
        <>
            <DesktopMenu user={user} isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} menuItems={menuItems} userMenuItems={userMenuItems} />
            <MobileMenu user={user} isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} menuItems={menuItems} userMenuItems={userMenuItems} />
        </>
    );
};
