    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Form
                        className="flex flex-col xl:flex-row justify-center items-center gap-4 p-2 mx-4 mb-4 w-full md:w-8/12 rounded bg-black bg-opacity-20"
                    >
                        <div
                            className="flex flex-col w-full md:flex-row md:w-full md:gap-4 lg:w-full md:justify-center"
                        >
                            <Field name="email">
